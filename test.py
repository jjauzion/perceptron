...
df.describe()
model = processing.NeuralNetwork(topology=args.topology, nb_itertion=100, regularization_rate=0.1)
model.train(np.delete(df.data, 1, axis=1), df.data[:, 1], gradient_checking=True)
